...
class Launcher(TmuxLauncher):
    def options(self):
        ...
        return [
            opt.specify(
                name="ffhq256_default2",
                #preprocess="resize_and_crop",
                load_size=256,crop_size=256,
                num_gpus=1, batch_size=8,   
                # Adjust the capacity of the networks to fit on colab GPU
    ...
    def train_options(self):
        ...
        return [opt.specify(
            ...
            save_freq=10000,
            print_freq=500) for opt in common_options]
